...
# Similar to depth first, uses a positional heuristic as well
...
def HillClimb(nN, queue, tries, sNodes):
	...
	if tries>=100:
		...
		successPath, tries = HillClimb(nN, queue, tries, sNodes)
...
def main():
	...
	hcPath, tries = HillClimb(nNetwork, queue, 0, ['S'])
	...
	if hcPath == 'Fail':
		...
		print("\nSUCCESS!")
		print(f"Path = {hcPath} :: Found in {tries+1} tries.\n")
